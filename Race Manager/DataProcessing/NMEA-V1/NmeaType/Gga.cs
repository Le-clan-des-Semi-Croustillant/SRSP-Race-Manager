...
namespace Race_Manager.DataProcessing.NMEA
{
    ...
    public class Gga : NmeaMessage, ITimestampedMessage, IGeographicLocation
    {
        ...
        public Gga(string type, string[] message) : base(type, message)
        {
            ...
            LatitudeVal = message[1];
            LatitudeCard = message[2];
            Longitude = NmeaMessage.StringToLongitude(message[3], message[4]);
            LongitudeVal = message[3];
            LongitudeCard = message[4];
        ...
        //public Gga.LatitudeLongitude LatitudeTrue { get; set; }
        ...
        //public Gga.LatitudeLongitude LongitudeTrue { get; set; }
