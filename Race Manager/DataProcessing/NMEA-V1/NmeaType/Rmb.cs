//  *******************************************************************************
//  *  Modifications copyright (C) 2022 <Sky-csc/Sky>
...
namespace Race_Manager.DataProcessing.NMEA
{
    ...
    public class Rmb : NmeaMessage
    {
        ...
        public Rmb(string type, string[] message) : base(type, message)
        {
            ...
            DestinationLatitudeVal = message[5];
            DestinationLatitudeCard = message[6];
            DestinationLongitude = NmeaMessage.StringToLongitude(message[7], message[8]);
            DestinationLongitudeVal = message[7];
            DestinationLongitudeCard = message[8];
        ...
        public string DestinationLatitudeVal { get; }
        public string DestinationLatitudeCard { get; }

        /// <summary>
        /// Destination Longitude
        /// </summary>
        public double DestinationLongitude { get; }
        public string DestinationLongitudeVal { get; }
        public string DestinationLongitudeCard { get; }
